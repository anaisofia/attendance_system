...
class CourseLevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_level" do
    assert_difference('CourseLevel.count') do
      post course_levels_url, params: { course_level: { code: @course_level.code, description: @course_level.description, name: @course_level.name } }
    end
  ...
  test "should update course_level" do
    patch course_level_url(@course_level), params: { course_level: { code: @course_level.code, description: @course_level.description, name: @course_level.name } }
